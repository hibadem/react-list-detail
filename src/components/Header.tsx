...
const Header = () => {
  const totalAmount = useSelector((state: any) => state.basket.total_amount);
  return (
    <header className="bg-primary flex justify-between md:justify-around p-2 text-base ">
      <div className="flex items-center gap-2 md:gap-24">
      <button data-collapse-toggle="navbar-default" type="button" className="inline-flex md:hidden items-center p-2 ml-3 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
      ...
      <div className="flex items-center gap-2.5 text-white">
        <img src={portfeil} />
        <div className="header__price">${totalAmount}</div>
        <img src={account} />
        <div>Halil</div>
      </div>
    </header>
